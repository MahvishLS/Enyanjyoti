  ...
  const cardDetails = [
    {
      ...
      image: "./images/e3.png",
      action: "Learn Now",
      link: "/educ"  // Changed to internal route
    },
    {
      title: "Career",
      description:
      ...
      image: "./images/e4.png",
      action: "Explore Now",
      link: "/career"  // Changed to internal route
    },
    {
      ...
      image: "./images/e5.png",
      action: "Check Now",
      link: "/loan"  // Changed to internal route
    },
  ];
          ...
          {cardDetails.map((item, index) => (
            <div key={index} className="card" style={{ maxWidth: "350px" }}>
              ...
              <div className="card-content">
                ...
                <Link to={item.link} className="btn-default card-button">
                  {item.action}
                </Link>
              </div>
            </div>
